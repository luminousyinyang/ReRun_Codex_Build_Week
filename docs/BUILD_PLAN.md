...
| --- | --- | --- |
| P0 | CRT shell and remote; five bundled topic-specific pilots; recap; learner-paced teaching before every CH 03 beat; worked examples for calculation checks; consequence flow; rewind; commercial review; ratings display; cliffhanger; paste-note live mode; responsive/a11y basics; judge docs | None |
